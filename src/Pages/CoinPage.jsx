...
import { useParams } from 'react-router-dom';// to access the parameter pass thru the url

const CoinPage = () => {
  const [coin, setCoin] = useState({});
  const params = useParams()// store the parameters
// we use back tick for string literal 
  const url =
  ...
  return (
    <div className='rounded-div my-12 py-8'>
      ...
      <div className='py-4'>
        ...
        {/* DomPurify is used to sanitize the html or simply get rid of the html */}
